...
//   miss                  … 現在問題のミス中フラグ（#439 盤面複製の伏字マス赤描画に使う）。undefined のときはキーを含めない。
export function toProgressPayload({ typed, total, mistakes, segStats, currentMistakes, initialLives, speed, elapsedMs, miss }) {

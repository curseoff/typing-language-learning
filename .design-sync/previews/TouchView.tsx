...
export const Miss = () => (
  <TouchView levelLabel="ホームポジション" modeLabel="やさしい" targets={targets} index={2} target="d" finished={false}
    {...common} hasError={true} wrongKey="s" pressed={{ key: 's', tick: 1, ok: false }} />
);

...
export interface QuizOptionLabelProps {
  opt: QuizOpt
  input: string
  picked: unknown
  hasError?: boolean
...
export default function QuizOptionLabel({ opt, input, picked, hasError }: QuizOptionLabelProps) {
    ...
    return (
      <span className="opt-ruby">
        <RubyTyped
          ...
          kanaDone={kanaDone}
          hasError={Boolean(typing) && hasError}
        />
      </span>
    )
  }

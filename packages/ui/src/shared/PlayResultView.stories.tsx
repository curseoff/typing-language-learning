...
// 単語／英英のプレイ結果 presenter。主成績は result.endCondition.kind から導出。
const meta = {
  title: 'shared/PlayResultView',
  component: PlayResultView,
} satisfies Meta<typeof PlayResultView>;
export default meta;
